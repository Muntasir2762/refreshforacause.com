<nav>
    <div class="container">
        <a href="" class="logo"><img src="{{ asset('images/site/logo/logo.png') }}" /></a>
        ...
        <div class="navigation navigation-top clearfix">
            <ul>
                ...
                <li class="left-side"><a href="index.html" class="logo-icon"><img
                            src="{{ asset('images/site/logo/logo.png') }}" alt="Alternate Text" /></a></li>
        ...
        <div class="navigation navigation-main">
            ...
            <div class="floating-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="index.html">Boxmenu <span class="open-dropdown"><i
                                    class="fa fa-angle-down"></i></span></a>
                                            ...
                                            <div class="col-lg-4">
                                                <ul>
                                                    ...
                                                    <li class="more"><a href="#"><i
                                                                class="icon icon-chevron-right"></i> More</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-4">
                                ...
                                <div class="box-sm">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="clearfix">
                                            ...
                                            <a class="btn btn-clean btn-big" href="products-grid.html">Shop
                                                now</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#">Megamenu <span class="open-dropdown"><i
                                    class="fa fa-angle-down"></i></span></a>
                        <div class="navbar-dropdown">
                            <div class="navbar-box">
                                <div class="box-full">
